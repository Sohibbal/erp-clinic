    ...
    <section className="py-24 bg-surface" id="features">
      <div className="max-w-container-max mx-auto px-margin">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="bg-white/70 backdrop-blur-xl border border-outline-variant/30 p-8 rounded-2xl hover:shadow-[0_10px_30px_-15px_rgba(183,110,121,0.1)] transition-all group animate-fade-in-up delay-100 hover:-translate-y-2 duration-300">
          ...
          {/* Card 2 */}
          <div className="bg-white/70 backdrop-blur-xl border border-outline-variant/30 p-8 rounded-2xl hover:shadow-[0_10px_30px_-15px_rgba(183,110,121,0.1)] transition-all group animate-fade-in-up delay-200 hover:-translate-y-2 duration-300">
            <div className="w-14 h-14 bg-surface-container-low rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary-container transition-colors">
          ...
          {/* Card 3 */}
          <div className="bg-white/70 backdrop-blur-xl border border-outline-variant/30 p-8 rounded-2xl hover:shadow-[0_10px_30px_-15px_rgba(183,110,121,0.1)] transition-all group animate-fade-in-up delay-300 hover:-translate-y-2 duration-300">
            <div className="w-14 h-14 bg-surface-container-low rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary-container transition-colors">
