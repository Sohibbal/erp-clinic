        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter items-center">
          <div className="flex flex-col gap-stack-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-fade-in-up delay-300">
              <button className="bg-primary-container text-on-primary-container font-headline-sm text-headline-sm px-8 py-4 rounded-xl hover:bg-primary-fixed-dim transition-colors shadow-sm flex items-center justify-center gap-2 hover:-translate-y-1 duration-300">
                Book a Demo
                <span className="material-symbols-outlined">arrow_forward</span>
              </button>
              <button className="bg-transparent border border-secondary text-secondary font-headline-sm text-headline-sm px-8 py-4 rounded-xl hover:bg-secondary/5 transition-colors flex items-center justify-center gap-2 hover:-translate-y-1 duration-300">
                View Pricing
              </button>
            </div>
          </div>
